...
// Source: github.com/kabelsea-sandbox/slice/pkg/apq (interfaces: CacheAdapter)
...
func (m *MockCacheAdapter) Add(arg0 context.Context, arg1 string, arg2 interface{}) {
	m.ctrl.T.Helper()
...
func (m *MockCacheAdapter) Get(arg0 context.Context, arg1 string) (interface{}, bool) {
	m.ctrl.T.Helper()
