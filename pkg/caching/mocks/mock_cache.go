...
// Source: github.com/kabelsea-games/chess-backend-app/internal/caching (interfaces: Cache)
...
func (m *MockCache) Get(arg0 context.Context, arg1, arg2 interface{}) (interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockCache) Set(arg0 context.Context, arg1, arg2 interface{}) error {
	m.ctrl.T.Helper()
